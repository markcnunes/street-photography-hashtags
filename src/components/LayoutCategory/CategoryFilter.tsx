...
import { updateHiddenCategories } from 'app/keywordsSlice';
...
const CategoryFilter: React.FC<ICategoryFilter> = ({ options }) => {
  ...
  const handleInputChange = (event: ChangeEvent<HTMLInputElement>) => {
    ...
    dispatch(updateHiddenCategories(updateHidenCategories));
