 ...
 */
const RandomPicker: React.FC<IRandomPicker> = ({ keywords }) => {
  const [randomPickedKeywords, setRandomPickedKeywords] = useState<TKeywords[]>(
    [],
  );
  ...
  const handleRandomSelection = () => {
    ...
    let optionsAvailable: TKeywords[] = keywords;
    let result: TKeywords[] = [];
