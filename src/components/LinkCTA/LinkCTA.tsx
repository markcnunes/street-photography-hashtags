...
import CategoryIcon from '../LayoutCategory/CategoryIcon';
...
const StyledLinkCTA = styled(Link)<LinkProps>((props) => ({
  position: 'relative',
  overflow: 'hidden',
  display: 'flex',
...
const LinkCTA: React.FC<ILinkCTA> = ({ icon, category, ...other }) => {
  return (
    <StyledLinkCTA to={category} {...other}>
